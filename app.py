...
# 데이터 저장 파일 (버전 관리를 위해 파일명 변경)
ACCUSE_FILE = 'accusations_v3.csv'
...
with tab2:
    ...
    if admin_pw == "12345":
        if not st.session_state.accuse_db.empty:
            ...
            st.write(f"**피고소인:** {case_info['피고소인']} | **상태:** {case_info['상태']}")
